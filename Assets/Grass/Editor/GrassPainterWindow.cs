    ...
    void DrawHandles()
    {
        ...
        switch (toolbarInt)
        {
            ...
            case 2:
                ...
                Handles.DrawWireDisc(hitPos, hitNormal, (toolSettings.brushFalloffSize * toolSettings.brushSize * .15f));
                Handles.color = discColor2;
                Handles.DrawSolidDisc(hitPos, hitNormal, (toolSettings.brushFalloffSize * toolSettings.brushSize * .15f));
        ...
        Handles.color = discColor;
        Handles.DrawWireDisc(hitPos, hitNormal, toolSettings.brushSize * .15f);
        Handles.color = discColor2;
        Handles.DrawSolidDisc(hitPos, hitNormal, toolSettings.brushSize * .15f);
